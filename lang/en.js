window.LANG_EN = {
  ...
  'files.demoLoaded':  '✓ Demo loaded: {name}',
  'files.delete':        'Remove',
  ...
  'nav.prevBtn':       '← Previous sentence',
  'nav.nextBtn':       'Next sentence →',
  ...
  'tagset.valuesPlaceholder': 'One value per line…',
  'tagset.errEmptyKey':       'Column key must not be empty.',
  'tagset.errDupKey':         'Duplicate column key: "{key}"',
  'tagset.warnEmpty':         'Tagset saved (no columns configured).',

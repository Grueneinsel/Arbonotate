...
function importSession(jsonText){
  ...
  state.projects = data.projects.map(p => {
    ...
    return {
      ...
      hiddenLabelCols:   p.hiddenLabelCols   || [],
      hiddenSpecialCols: p.hiddenSpecialCols || [],
      undoStack:   p.undo  || [],
      redoStack:   p.redo  || [],
...
function _buildSessionObject(){
  ...
  return {
    ...
    projects: state.projects.map(p => ({
      ...
      hiddenLabelCols:   p.hiddenLabelCols   instanceof Set ? Array.from(p.hiddenLabelCols)   : (p.hiddenLabelCols   || []),
      hiddenSpecialCols: p.hiddenSpecialCols instanceof Set ? Array.from(p.hiddenSpecialCols) : (p.hiddenSpecialCols || []),
      undo:        p.undoStack || [],
      redo:        p.redoStack || [],
